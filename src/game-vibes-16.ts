/**
 * Gaming theme board with 16 cards: picks 8 motifs, doubles and shuffles them,
 * renders the playing field and wires up the pause popup.
 */
import "./styles/style.scss";
import "./styles/gaming-vibes/main-gaming-vibes.scss";
import "./styles/gaming-vibes/game-vibes-16.scss";
 ...
 */
mixCards(motifs);
const selection = motifs.slice(0, 8);
