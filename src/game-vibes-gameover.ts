 ...
 */
import "./styles/gaming-vibes/game-over-game-vibes.scss";
...
function showWinnerPage() {
    if (pointsBlue > pointsOrange) {
        window.location.href = `${import.meta.env.BASE_URL}html/win-blue-gaming.html`;
    } else if (pointsOrange > pointsBlue) {
        window.location.href = `${import.meta.env.BASE_URL}html/win-orange-gaming.html`;
    } else {
        window.location.href = `${import.meta.env.BASE_URL}html/draw-gaming.html`;
    }
}
